...
do
	...
	paste secs.log CLEANER_RECLAIM_COMMITTED_EXTENTS_${name}_PER_SAMPLING.plot &> CLEANER_RECLAIM_COMMITTED_EXTENTS_${name}_PER_SAMPLING.with_time.plot
done
...
paste secs.log CLEANER_RECLAIM_COMMITTED_EXTENTS_*_PER_SAMPLING.plot &> CLEANER_RECLAIM_COMMITTED_EXTENTS_PER_SAMPLING.with_time.plot
